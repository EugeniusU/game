...
let showLegendButton = document.querySelector('#showLegend');
...
///    canvas.clearRect(x + 10, y + 10, width - 15, height - 15)
    canvas.clearRect(x + 3, y + 3, width - 3, height - 3);
}
...
///drawCube(100, 100, 70, 70);
let imgWidth = field.getBoundingClientRect().width / 100 * 8;
///let cube = {width: 30, height: 30, x: 10, y: 15, sizeNum: 20};
let cube = {width: imgWidth, height: imgWidth, x: 10, y: imgWidth - imgWidth / 3, sizeNum: 20};
drawCube(cube.width, cube.height, cube.x, cube.y);
